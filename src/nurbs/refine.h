...
void RefineKnotVectCurve(int p, const vector<T> &U, 
    const vector<glm::vec<4, T>> &Pw, const vector<T> &X,
    vector<T> &Ubar, vector<glm::vec<4, T>> &Qw)
{
    if (X.size() == 0)
        return;
...
void RefineKnotVectU(int p, const vector<T> &U,
    const array2<glm::vec<4, T>> &Pw, const vector<T> &X,
    vector<T> &Ubar, array2<glm::vec<4, T>> &Qw)
{   
    if(X.size() == 0) return;
...
void RefineKnotVectV(int q, const vector<T> &V,
    const array2<glm::vec<4, T>> &Pw, const vector<T> &X,
    vector<T> &Vbar, array2<glm::vec<4, T>> &Qw)
{   
    if(X.size() == 0) return;
...
void RefineKnotVectSurface(int p, int q, const vector<T> &U, const vector<T> &V,
    const array2<glm::vec<4, T>> &Pw, const vector<T> &X, const vector<T> &Y,
                           vector<T> &Ubar, vector<T> &Vbar, array2<glm::vec<4, T>> &Qw)
{
    array2<glm::vec<4, T>> Mw;
